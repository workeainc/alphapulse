...
def test_quantization_system():
    ...
    try:
        from ..ai.model_quantization import model_quantization_system
...
def test_onnx_inference_engine():
    ...
    try:
        from ..ai.onnx_inference import onnx_inference_engine
...
def test_onnx_converter():
    ...
    try:
        from ..ai.onnx_converter import onnx_converter
