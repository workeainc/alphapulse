...
async def test_core_consolidated_functionality():
    ...
    try:
        ...
        try:
            ...
            from ..ai.retraining.orchestrator import RetrainingOrchestrator
            from ..ai.retraining.data_service import RetrainingDataService
            from ..ai.retraining.trigger_service import AutoRetrainTriggerService
            from ..ai.retraining.drift_monitor import DriftDetectionMonitor
