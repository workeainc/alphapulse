...
async def test_data_collection_components():
    ...
    try:
        # Import components
        from app.data_collection.enhanced_data_collection_manager import EnhancedDataCollectionManager
        from app.data_collection.market_intelligence_collector import MarketIntelligenceCollector
        from app.data_collection.volume_positioning_analyzer import VolumePositioningAnalyzer
        import ccxt
...
async def test_analysis_engine():
    ...
    try:
        # Import components
        from app.analysis.intelligent_analysis_engine import IntelligentAnalysisEngine
        import ccxt
