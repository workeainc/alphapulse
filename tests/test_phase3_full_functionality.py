...
class Phase3FullFunctionalityTester:
    ...
    async def test_twitter_api(self) -> bool:
        ...
        try:
            from app.services.sentiment_service import TwitterSentimentAnalyzer
    ...
    async def test_reddit_api(self) -> bool:
        ...
        try:
            from app.services.sentiment_service import RedditSentimentAnalyzer
    ...
    async def test_news_api(self) -> bool:
        ...
        try:
            from app.services.sentiment_service import NewsSentimentAnalyzer
