...
# Import from the main models.py file, not the models directory
from src.database.models import Base, SignalRecommendation, PerformanceMetrics, Signal
...
async def add_sample_data(session):
