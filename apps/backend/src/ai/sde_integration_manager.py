...
class SDEIntegrationManager:
    ...
    async def integrate_sde_with_signal(self, 
        ...
        try:
            ...
            if consensus_result.consensus_achieved and hasattr(consensus_result, 'direction') and consensus_result.direction != SignalDirection.FLAT:
                ...
                direction = consensus_result.direction.value if hasattr(consensus_result, 'direction') and consensus_result.direction else None
            ...
            if consensus_result.consensus_achieved and hasattr(consensus_result, 'probability') and consensus_result.probability > 0:
    ...
    def _calculate_final_confidence(self,
        ...
        try:
            ...
            base_confidence = getattr(consensus_result, 'probability', 0.0) if consensus_result.consensus_achieved else 0.0
    ...
    async def _store_integration_results(self, signal_id: str, symbol: str, timeframe: str,
        ...
        try:
            async with self.db_pool.acquire() as conn:
                ...
                """, signal_id, symbol, timeframe, consensus_result.consensus_achieved,
                     consensus_result.direction.value if hasattr(consensus_result, 'direction') and consensus_result.direction else None,
                     getattr(consensus_result, 'probability', 0.0), getattr(consensus_result, 'agreeing_heads_count', 0), 3, 0.70)
