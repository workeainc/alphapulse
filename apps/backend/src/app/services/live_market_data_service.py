...
# AlphaPulse focuses on signal analysis, not trade execution
# Use SignalRecommendation model from src.database.models instead

class LiveMarketDataService:
    """
    Live market data service
    Handles real-time market data collection for analysis and signal generation
    Does NOT execute trades - provides data for signal recommendations only
    """
    ...
    # REMOVED: execute_trade() and _store_trade_execution() methods
    # AlphaPulse is a signal analysis engine, not a trading execution platform
    # Trade execution should be done manually by users based on recommendations
