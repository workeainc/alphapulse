...
from src.app.core.database_manager import db_manager, initialize_database, close_database
from src.app.core.service_manager import service_manager, initialize_all_services, shutdown_all_services, register_service
...
try:
    from src.ai.real_time_pipeline import RealTimePipeline
