...
class AlphaPulseMain:
    ...
    async def initialize_database(self) -> bool:
        ...
        for attempt in range(max_retries):
            try:
                ...
                try:
                    from ..src.database.enhanced_connection import EnhancedTimescaleDBConnection
    ...
    async def initialize_performance_framework(self) -> bool:
        ...
        try:
            ...
            try:
                from src.app.core.performance_profiling import get_performance_profiler
                from src.app.core.benchmark_framework import get_benchmark_framework
                from src.app.core.performance_regression import get_performance_regression_tester
