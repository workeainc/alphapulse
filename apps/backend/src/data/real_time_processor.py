...
try:
    from ..src.strategies.real_time_signal_generator import RealTimeSignalGenerator, TradingSignal
...
class RealTimeCandlestickProcessor:
    ...
    def _parse_candlestick(self, candlestick_data: Dict) -> Optional[Dict]:
        """Parse raw candlestick data from WebSocket with robust volume parsing"""
        try:
