...
class IntegrationGuide:
    ...
    def show_integration_steps(self):
        ...
        print("from src.ai.multi_timeframe_pattern_engine import MultiTimeframePatternEngine")
        print("from src.ai.pattern_failure_analyzer import PatternFailureAnalyzer")
        print("from src.database.connection import TimescaleDBConnection")
        print("```")
