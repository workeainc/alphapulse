...
def test_phase2_backtesting_enhancements():
    ...
    try:
        ...
        from ..src.ai.advanced_backtesting import (
            AdvancedBacktester, KPIConfig, LatencyConfig, SymbolConfig,
            BacktestType
        )
        
        # Import dependencies
        from ..src.ai.risk_management import RiskManager
        from ..src.ai.position_sizing import PositionSizingOptimizer
        from ..src.ai.market_regime_detection import MarketRegimeDetector
