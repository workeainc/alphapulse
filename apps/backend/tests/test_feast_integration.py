...
async def test_feast_config_creation():
    ...
    try:
        ...
        from ..src.ai.feast_config import create_feast_structure, get_feast_paths
...
async def test_feast_feature_definitions():
    ...
    try:
        ...
        from ..src.ai.feast_feature_definitions import (
...
async def test_feast_feature_store_manager():
    ...
    try:
        ...
        from ..src.ai.feast_feature_store import FeastFeatureStoreManager
...
async def test_online_feature_serving():
    ...
    try:
        ...
        from ..src.ai.feast_feature_store import get_online_features
...
async def test_offline_feature_serving():
    ...
    try:
        ...
        from ..src.ai.feast_feature_store import get_offline_features
...
async def test_feature_computation():
    ...
    try:
        ...
        from ..src.ai.feast_feature_store import compute_features
