...
from src.app.core.model_comparison_manager import model_comparison_manager, ModelVersion, ModelComparisonResult
...
async def test_model_comparison_manager():
    ...
    try:
        ...
        for scenario in test_scenarios:
            ...
            from src.app.core.accuracy_evaluator import BaselineComparison, ModelAccuracyMetrics
    ...
    try:
        ...
        from src.app.core.accuracy_evaluator import BaselineComparison
