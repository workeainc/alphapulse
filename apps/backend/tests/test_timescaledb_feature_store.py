...
async def test_feature_store_initialization():
    ...
    try:
        ...
        from ..src.ai.feature_store_timescaledb import TimescaleDBFeatureStore
...
async def test_feature_registration():
    ...
    try:
        ...
        from ..src.ai.feature_store_timescaledb import TimescaleDBFeatureStore, FeatureDefinition
...
async def test_feature_sets():
    ...
    try:
        ...
        from ..src.ai.feature_store_timescaledb import TimescaleDBFeatureStore, FeatureSet
...
async def test_feature_computation_pipeline():
    ...
    try:
        ...
        from ..src.ai.feature_store_timescaledb import TimescaleDBFeatureStore
        from ..src.ai.feature_computation_pipeline import FeatureComputationPipeline, ComputationJob
...
async def test_batch_computation():
    ...
    try:
        ...
        from ..src.ai.feature_store_timescaledb import TimescaleDBFeatureStore
        from ..src.ai.feature_computation_pipeline import FeatureComputationPipeline
