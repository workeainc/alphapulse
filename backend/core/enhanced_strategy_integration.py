...
try:
    ...
    from ..ai.multi_timeframe_fusion import MultiTimeframeFusion
...
class EnhancedStrategyIntegration:
    ...
    async def _apply_mtf_fusion(self, integrated_signal: IntegratedSignal, market_data: Dict[str, Any]) -> IntegratedSignal:
        ...
        try:
            ...
            from ..ai.multi_timeframe_fusion import TimeframeSignal, SignalDirection, SignalStrength
    ...
    async def record_strategy_performance(self, 
        ...
        if self.ensemble_manager:
            from ..strategies.ensemble_strategy_manager import StrategyPerformance
