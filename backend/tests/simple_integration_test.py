"""
Simple Integration Test for AlphaPlus
...
def test_consensus_manager():
    ...
    try:
        ...
        # Test consensus with mock results
        mock_results = {
...
def test_model_heads():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ ModelHeadsManager ML analysis failed (expected): {e}")
...
def test_sde_framework():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ SDEFramework analysis failed (expected): {e}")
...
def test_news_sentiment_service():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️ NewsSentimentService API test failed (expected): {e}")
