...
try:
    ...
    from streaming.candle_builder import CandleBuilder
    from streaming.rolling_state_manager import RollingStateManager
    ...
    class SDEFramework:
        ...
        async def generate_sde_output(self, model_results, df, symbol, timeframe, account_id):
            ...
            from ai.sde_framework import SDEOutput, SignalDirection, TPStructure
            return SDEOutput(
    ...
    class ConsensusManager:
        ...
        async def check_consensus(self, model_results):
            ...
            from ai.consensus_manager import ConsensusResult, SignalDirection, ModelHead
...
# Import API routers
from app.api.single_pair import router as single_pair_router
