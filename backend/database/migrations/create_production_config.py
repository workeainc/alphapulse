#!/usr/bin/env python3
"""Script to create production config with proper UTF-8 encoding"""

import os

# Production config content
config_content = '''"""Production Configuration for AlphaPulse - Enterprise Edition"""
...
# Write the production config file with UTF-8 encoding
with open('config/production.py', 'w', encoding='utf-8') as f:
    f.write(config_content)

print("✅ Production config file created successfully with UTF-8 encoding")
